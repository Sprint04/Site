...
function cadastrarCargo(nome, hist, add, adm, fkEmpresa) {
    ...
    ((select top 1 idCargo from cargo where nome = '${nome}' and fkEmpresa = ${fkEmpresa}), 1, ${hist}),
    ((select top 1 idCargo from cargo where nome = '${nome}' and fkEmpresa = ${fkEmpresa}), 2, ${add}),
    ((select top 1 idCargo from cargo where nome = '${nome}' and fkEmpresa = ${fkEmpresa}), 3, ${adm});
    `
    console.log("Executando a instrução SQL: \n" + instrucao);
